...
const translations = {
  pt: {
    ...
    hero_store_steam_sub: "Download para PC",
    hero_store_steam_title: "Steam",
    hero_store_steam_tag: "Live",
    hero_store_windows_sub: "Download Oficial",
    hero_store_windows_title: "Microsoft Store",
    hero_store_windows_tag: "Live",
    hero_store_meta_sub: "Painel 2D Flutuante",
    hero_store_meta_title: "Meta Quest",
    ...
    // Platforms Showcase
    platforms_tag: "ECOSSISTEMA MULTIPLATAFORMA",
    platforms_title: "Jogue Onde Quiser, Como Quiser",
    platforms_subtitle: "O TamaWhere foi construído do zero para se adaptar com perfeição e controles sob medida a cada formato de tela e dispositivo.",
    plat_win_title: "Windows PC & Steam",
    plat_win_badge: "Steam & MS Store",
    plat_win_desc: "Experiência desktop completa com atalhos de teclado ágeis, modo carcaça retrô ou janela compacta (F2/Tab), minimização inteligente para a bandeja do sistema (Tray) e notificações nativas do Windows Toast.",
    plat_win_steam_btn: "Jogar na Steam",
    plat_win_btn: "Microsoft Store",
    plat_win_status: "Disponível na Loja Oficial",
    plat_quest_title: "Meta Quest (VR & MR)",
    plat_quest_badge: "Horizon OS",
    plat_quest_desc: "Leve seu companheiro virtual para a computação espacial! O jogo roda em um painel espacial flutuante em 2D dentro do Meta Quest (2, 3, 3S e Pro), jogável em VR ou no Passthrough colorido (Mixed Reality) com suporte a ponteiros de controle e Hand Tracking.",
    plat_quest_btn: "Ver no Meta Horizon Store",
    plat_quest_status: "Disponível na Loja Oficial",
    plat_wear_title: "Smartwatches (Wear OS)",
    ...
    footer_store_steam: "Steam (Windows PC)",
    footer_store_windows: "Microsoft Store (Windows)",
    footer_store_meta: "Meta Quest (Horizon Store)",
    footer_play_store: "Google Play (Wear OS & Mobile)",
  ...
  en: {
    ...
    hero_store_steam_sub: "Get for PC",
    hero_store_steam_title: "Steam",
    hero_store_steam_tag: "Live",
    hero_store_windows_sub: "Get for Windows",
    hero_store_windows_title: "Microsoft Store",
    hero_store_windows_tag: "Live",
    hero_store_meta_sub: "Floating 2D Panel",
    hero_store_meta_title: "Meta Quest",
    hero_store_meta_tag: "Live",
    ...
    // Platforms Showcase
    platforms_tag: "CROSS-PLATFORM ECOSYSTEM",
    platforms_title: "Play Anywhere, Any Way You Want",
    platforms_subtitle: "TamaWhere is built from the ground up to adapt seamlessly with tailored native controls for every screen size and form factor.",
    plat_win_title: "Windows PC & Steam",
    plat_win_badge: "Steam & MS Store",
    plat_win_desc: "Complete desktop experience with responsive keyboard shortcuts, retro toy frame or compact borderless window (F2/Tab), smart system tray minimization, and native Windows Toast notifications.",
    plat_win_steam_btn: "Play on Steam",
    plat_win_btn: "Microsoft Store",
    plat_win_status: "Available on Official Store",
    plat_quest_title: "Meta Quest (VR & MR)",
    plat_quest_badge: "Horizon OS",
    plat_quest_desc: "Bring your virtual companion into spatial computing! Operates in an interactive floating 2D panel inside Meta Quest (2, 3, 3S, and Pro), playable in full VR or colorful Passthrough (Mixed Reality) with controller pointer and Hand Tracking support.",
    plat_quest_btn: "View on Meta Horizon Store",
    plat_quest_status: "Available on Meta Horizon Store",
    plat_wear_title: "Smartwatches (Wear OS)",
    plat_wear_badge: "Wearable",
