...
const translations = {
  pt: {
    ...
    hero_store_meta_tag: "Em Publicação",
    ...
    plat_win_badge: "Microsoft Store",
    ...
    plat_win_btn: "Baixar na Microsoft Store",
    ...
    plat_quest_status: "Em processo de publicação",
  ...
  en: {
    ...
    // Hero
    hero_badge: "🎮 AVAILABLE ON WEAR OS, ANDROID, WINDOWS & META QUEST",
    ...
    plat_win_btn: "Get on Microsoft Store",
    ...
    plat_quest_status: "In publication process",
    plat_wear_title: "Smartwatches (Wear OS)",
    plat_wear_badge: "Wearable",
